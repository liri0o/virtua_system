        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.tutors.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        @error('cedula')
                            <p class="text-red-600 text-sm"> *{{ $message }}</p>
                        @enderror
                        <x-input class="mt-2 block w-full" type="text" placeholder="Ingrese la cédula del tutor"
                ...
                <div class="row">
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        <x-input class="mt-2 block w-full" type="email"
                            placeholder="Ingrese el correo electrónico " name="email"
                            value="{{ old('email') }}" />
                    </div>
                    <div class="mb-4 col-md-3">
                        <label class="mb-1 block">
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        @error('tlf')
                            <p class="text-red-600 text-sm"> *{{ $message }}</p>
                        @enderror
                        <x-input class="mt-2 block w-full" type="tel" placeholder="Número telefónico del tutor"
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        <x-select name="carrera_id" class="w-full mt-1">
                            ...
                            @foreach ($carreras as $carrera)
                                <option value="{{ $carrera->id }}" @selected(old('carrera_id') == $carrera->id)>{{ $carrera->name }}
                                </option>
                            @endforeach
                        </x-select>
                    </div>
                ...
                <div class="flex justify-end w-full">
                    ...
                    <x-adminlte-button class="btn-flat" type="submit" label="Crear Tutor" theme="success"
