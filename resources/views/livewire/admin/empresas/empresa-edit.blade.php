                    ...
                    <div class="grid grid-cols-3 grid-rows-2 gap-4">
                        ...
                        <div class="">
                            ...
                            <div class="relative mb-4 justify-center w-full">
                                ...
                                <img class="block w-50 h-50 rounded-full m-auto shadow object-contain object-center border-2 border-gray-200 border-solid dark:border-gray-300"
                                    src="{{ $photo ? $photo->temporaryUrl() : Storage::url($empresaEdit['photo']) }}"
                                    alt="">
                            </div>
                            <label
                        ...
                        <div class="col-span-2 row">
                            ...
                            <div class="mb-2 col-md-6">
                                ...
                                <x-input-error for="empresaEdit.email" />
                                <x-input class="mt-2 block w-full" type="text"
                                    placeholder="Ingrese el nombre de la empresa" name="email"
                                    wire:model="empresaEdit.email" />
                            </div>
                            ...
                            <div class="mb-2 col-md-6">
                                ...
                                <x-input-error for="empresaEdit.tlf_2" />
                                <x-input class="mt-2 block w-full" type="tel" placeholder="Ingrese un número telefónico"
                                    name="tlf_2" wire:model="empresaEdit.tlf_2" />
                            </div>
                            <div class="mb-2 col-md-12">
                                <label class="mb-1 block">
                                    Dirección de la Empresa
                                </label>
                                <x-input-error for="empresaEdit.direccion" />
                                <x-input class="mt-2 block w-full" type="text"
                                    placeholder="Ingrese el nombre de la empresa" name="direccion"
                                    wire:model="empresaEdit.direccion" />
                            </div>
                        </div>
                        ...
                        <div class="col-span-3 row-start-2">
                            <div class="mb-2 col-md-12">
                                ...
                                <x-input-error for="empresaEdit.description" />
                                <x-textarea wire:model="empresaEdit.description" class="w-full resize-none h-40"
                            ...
                            <div class=" flex justify-end w-full">
                                ...
                                <x-adminlte-button class="btn-flat mr-2" type="submit" label="Guardar Cambios" theme="success"
